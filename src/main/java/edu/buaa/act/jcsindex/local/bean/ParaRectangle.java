...
/**
 * Created by shmin at 2018/7/5 23:32
 **/
/**
 * Currently hardcoded to 2 dimensions, but could be extended.
 */
public class ParaRectangle implements java.io.Serializable {

    /**
     *
     */
    private static final long serialVersionUID = 2855516235804901681L;
    /**
     * use primitives instead of arrays for the coordinates of the rectangle, to reduce memory requirements.
     */
    public float minX, minY, maxX, maxY;

    public ParaRectangle() {
     ...
     *            (see x2)
     */
    public ParaRectangle(float x1, float y1, float x2, float y2) {
        set(x1, y1, x2, y2);
    }
     ...
     */
    public void set(ParaRectangle r) {
        minX = r.minX;
        minY = r.minY;
        maxX = r.maxX;
        maxY = r.maxY;
     ...
     */
    public ParaRectangle copy() {
        return new ParaRectangle(minX, minY, maxX, maxY);
    }

    /**
     * Determine whether an edge of this rectangle overlies the equivalent edge of the passed rectangle
     */
    public boolean edgeOverlaps(ParaRectangle r) {
     ...
     */
    public boolean intersects(ParaRectangle r) {
     ...
     */
    static public boolean intersects(float r1MinX, float r1MinY, float r1MaxX, float r1MaxY, float r2MinX, float r2MinY,
                                     float r2MaxX, float r2MaxY) {
     ...
     */
    public boolean contains(ParaRectangle r) {
     ...
     */
    static public boolean contains(float r1MinX, float r1MinY, float r1MaxX, float r1MaxY, float r2MinX, float r2MinY,
                                   float r2MaxX, float r2MaxY) {
     ...
     */
    public boolean containedBy(ParaRectangle r) {
     ...
     */
    public float distance(ParaPoint p) {
    ...
    public float distance(ParaRectangle r) {
        float distanceSquared = 0;
     ...
     * @return enlargement
     */
    public float enlargement(ParaRectangle r) {
     ...
     * @return enlargement
     */
    static public float enlargement(float r1MinX, float r1MinY, float r1MaxX, float r1MaxY, float r2MinX, float r2MinY,
                                    float r2MaxX, float r2MaxY) {
     ...
     */
    public void add(ParaRectangle r) {
        if (r.minX < minX)
            minX = r.minX;
        if (r.maxX > maxX)
            maxX = r.maxX;
     ...
     */
    public ParaRectangle union(ParaRectangle r) {
        ParaRectangle union = this.copy();
        union.add(r);
        return union;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof ParaRectangle) {
            ParaRectangle r = (ParaRectangle) o;
     ...
     *
     * Note that two rectangles can be equal but not the same object, if they both have the same bounds.
     *
     * @param o
     *            The object to compare with this rectangle.
     */
    ...
    public ParaPoint centre() {
        return new ParaPoint((minX + maxX) / 2, (minY + maxY) / 2);
    }
