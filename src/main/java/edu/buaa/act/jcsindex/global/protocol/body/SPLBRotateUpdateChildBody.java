/*
 * @(#) SPLBRotateUpdateChildBody.java 1.0 2006-2-22
 * 
...
/**
 * Implement the message body used for updating the child links 
...
public class SPLBRotateUpdateChildBody extends Body implements Serializable
{
	 ...
	 * Construct the message body with speicified parameters.
  	 ...
  	 */
  	public SPLBRotateUpdateChildBody(PhysicalInfo physicalSender, LogicalInfo logicalSender,
	 ...
	 */
  	public SPLBRotateUpdateChildBody(String serializeData)
  	{
  		...
  		{
  			System.out.println("Incorrect serialize data at LBRotateUpdateChild:" + serializeData);
