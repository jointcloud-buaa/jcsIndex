...
/**
 * Implement the message body used for replying 
 * SPUpdateRoutingTableDirectly protocol
 * 
 * @author Vu Quang Hieu
 * @version 1.0 2006-2-22
 */

public class SPUpdateRoutingTableReplyBody extends Body implements Serializable
{

	// private members
	private static final long serialVersionUID = -6841327272488296987L;
	 ...
	 */
	public SPUpdateRoutingTableReplyBody(PhysicalInfo physicalSender, LogicalInfo logicalSender,
	 ...
	 */
	public SPUpdateRoutingTableReplyBody(String serializeData)
	{
	...
	public String getString()
	{
		...
		outMsg = "UPDATEROUTINGTABLEREPLY";
