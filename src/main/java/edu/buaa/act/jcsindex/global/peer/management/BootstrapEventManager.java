/*
 * @(#) BootstrapEventManager.java 1.0 2006-1-24
 * 
...
public class BootstrapEventManager extends AbstractEventManager
{
	 ...
	 */
	public BootstrapEventManager(AbstractInstance instance, int port, int maxConn)
	{
	...
	{
		this.eventHandlers = new BootstrapEventDispatcher[this.maxConn];
		for (int i = 0; i < maxConn; i++)
		{
			eventHandlers[i] = new BootstrapEventDispatcher(instance);
